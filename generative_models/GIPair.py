...
if __name__=="__main__":
    ...
    GIP = GIPair(rng=rng, \
            Xd=Xd, Xc=Xc, Xm=Xm, \
            g_net=p_xt_given_z, i_net=q_z_given_x, \
            data_dim=x_dim, prior_dim=z_dim, \
            params=None, shared_param_dicts=None)
    ...
    for i in range(220000):
        ...
        if ((i % 5000) == 0):
            ...
            file_name = "gip_post_klds_b{0:d}.png".format(i)
