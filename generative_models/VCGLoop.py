...
if __name__=="__main__":
    ...
    for i in range(1000000):
        ...
        if True:
            ...
            # # #
            joint_cost_2 = 1.0
            chain_nll_cost_2 = 1.0
            chain_kld_cost_2 = 1.0
            chain_vel_cost_2 = 1.0
            mask_nll_cost_2 = 1.0
            mask_kld_cost_2 = 1.0
            disc_cost_gn_2 = 1.0
            disc_cost_dn_2 = 1.0
            other_reg_cost_2 = 1.0
        if ((i % 4) == 0):
            #########################################
            ...
            # # #
            #joint_cost_1 = 1.0
            #chain_nll_cost_1 = 1.0
            #chain_kld_cost_1 = 1.0
            #chain_vel_cost_1 = 1.0
            #mask_nll_cost_1 = 1.0
            #mask_kld_cost_1 = 1.0
            #disc_cost_gn_1 = 1.0
            #disc_cost_dn_1 = 1.0
            #other_reg_cost_1 = 1.0
        if ((i % 1000) == 0):
