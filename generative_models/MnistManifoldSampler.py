...
def pretrain_gip_60k():
    ...
    for i in range(50000):
        ...
        if ((i % 5000) == 0):
            ...
            # draw generator net final layer weights
            file_name = RESULT_PATH+"pt60k_gip_gen_weights_b{0:d}.png".format(i)
...
def train_walk_from_pretrained_gip():
    ...
    if START_FRESH:
        ...
        #######################################################
        gn_fname = RESULT_PATH+"pt60k_gip_params_GN.pkl"
        in_fname = RESULT_PATH+"pt60k_gip_params_IN.pkl"
